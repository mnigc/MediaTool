...
- **工具箱布局** — 左侧分类工具树（常用/视频/音频/图片/通用）+ 底部统一任务坞，不同工具的任务可同时进行
- **压缩与转换** — H.264、VP9、AV1 (SVT-AV1) 编码，CRF/目标大小/固定码率三种质量模式，分辨率（480p ~ 2160p）、帧率、编码速度、裁剪、元数据剥离
...
- **音频转换与提取** — MP3/AAC/M4A/Opus/FLAC，码率可调
...
- **多语言** — 中文、English、한국어、日本語 | **主题** — 浅色 / 深色 / 跟随系统
