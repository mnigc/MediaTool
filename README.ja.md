...
- **ツールボックスレイアウト** — 左側カテゴリツールツリー + 下部統合タスクドック、異なるツールのタスクを同時実行
- **動画圧縮・変換** — H.264、VP9、AV1 (SVT-AV1) エンコード、CRF/目標サイズ/固定ビットレート品質モード、カスタム解像度（480p〜2160p）、フレームレート、エンコード速度、トリム制御
...
- **メタデータ除去** — EXIF/GPS などの個人情報をワンクリックで削除
